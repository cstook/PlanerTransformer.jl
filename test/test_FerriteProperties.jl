...
test_fp = FerriteProperties(0.2e6:0.5e6,25,100,
                            BHloop(15,.44,.15),
                            BHloop(10,.345,.120),
                            SpecificPowerLossData(test_spldata))
...
@test flux_density(test_fp.spl_hot,50114.55055175903,600e3)≈0.02
@test flux_density(test_fp,50114.55055175903,600e3)≈0.02
end # testset
