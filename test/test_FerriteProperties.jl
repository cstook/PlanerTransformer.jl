...
@test specificpowerloss(test_fp.spl_hot,0.2,15e3)≈72926.68854848042
@test specificpowerloss(test_fp.spl_hot,0.1,50e3)≈24158.470844381052
@test specificpowerloss(test_fp.spl_hot,0.07,150e3)≈37883.89793616807
@test specificpowerloss(test_fp.spl_hot,0.05,300e3)≈52475.72366004552
@test specificpowerloss(test_fp.spl_hot,0.02,600e3)≈42277.685735775805
@test specificpowerloss(test_fp.spl_hot,0.01,1e6)≈51375.309340858454
